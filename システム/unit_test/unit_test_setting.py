...
# GOALS_TEST
TEST_GOAL_TITLE = TODAY_STR + '_test_goal_title'
TEST_GOAL_TITLE_UPDATE = NOW + '_test_goal_title'
TEST_ACTION = TODAY_STR + '_test_action'
...
TEST_LINK_RESULT_06 = [(5, 6, 'LINKED_GOAL')]
TEST_LINK_EXIST_07 = 7
TEST_LINK_RESULT_08 = [(7, 8, 'LINKED_GOAL')]
TEST_LINK_NOTEXIST_09 = 9
TEST_LINK_NOTEXIST_10 = 10
TEST_LINK_USER_ID = 3
TEST_GET_LINKS = [(5, 6, 'LINKED_GOAL'), (6, 5, 'LINKED_GOAL'), (7, 8, 'LINKED_GOAL'), (8, 7, 'LINKED_GOAL')]